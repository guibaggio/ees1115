...
for file_name in multimodel:
    ...
    #print(file_name)
    #calculate
    t_mean = tm.tasmax.mean('time')
    t_std = tm.tasmax.std('time')
    #append
...
t_mmm = xr.concat(t_mean_multimodel,pd.Index(range(25),name='model'))
t_msm = xr.concat(t_std_multimodel,pd.Index(range(25),name='model'))
